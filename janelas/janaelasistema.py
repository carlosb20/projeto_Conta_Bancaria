...
class Sismeta(Tk):
    def __init__(self, *args):
        ...
        self.frame_btn_entry.pack(pady=25 , padx=50)
        ...
        self.btn_deposito.grid(row=0, column=0,pady=20)    

        #-----------------------------------btn saque ----------------------------------------------

        self.btn_saque = ctk.CTkButton(self.frame_btn_entry, text="Saque")
        #self.label_transferencia.bind("<Button-1>", self.transferencia)
        self.btn_saque.grid(row=1, column=0,pady=20)

        #---------------------------- extrato -----------------------------------------------

        self.btn_extrato = ctk.CTkButton(self.frame_btn_entry, text="Extrato")
        #self.label_sair.bind("<Button-1>", self.sair)
        self.btn_extrato.grid(row=2, column=0,pady=20)

        #---------------------------- transferencia -----------------------------------------------

        self.btn_transferencia = ctk.CTkButton(self.frame_btn_entry, text="Transferencia")
        #self.label_sair.bind("<Button-1>", self.sair)
